...
module Http.Response
  ( Status(..)
  , ok, created, noContent, partialContent, notModified
  , badRequest, notFound, conflict, preconditionFailed
  , methodNotAllowed, notImplemented
  , lengthRequired, payloadTooLarge, rangeNotSatisfiable
  , internalServerError
...
ok, created, noContent, partialContent, notModified :: Status
ok               = Status 200 "OK"
...
badRequest, notFound, conflict, preconditionFailed :: Status
...
lengthRequired, payloadTooLarge, rangeNotSatisfiable :: Status
