...
- `bench/` — curated benchmark artefacts 
...
During benchmarking, the harness writes transient run/session/log outputs under:
- bench/runs/
- bench/sessions/
- bench/server_logs/

These transient directories are not included in the submission archive.
The submission instead contains curated benchmark artefacts under bench/:
